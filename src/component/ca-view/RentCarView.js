...
const RentCarView = () => {
    const {id} = useParams();
    const {data : car , isLoading , error} = UseFetch(' http://localhost:8001/carsForrent/'+id);
    ...
    return ( 
            <div className="car-details">
                    ...
                    <div className="details" key={id}>
                        <div className="row">
                                    ...
                                    <div className="row" ref={myRef}>
                                        ...
                                        car.smallsrc.map((img , index)=>(
                                            <div className="col-3" key={index}>
                                                <img alt="" src={img}  onClick={()=>handleClick(index)}/>
                                            </div>
                                            )) 
                                        }
                                    </div>
                            ...
                            <div className="col-md-6 col-12 order-1 order-md-2">
                                ...
                                <Zoom>
                                    <img alt="" src={car.smallsrc[index]} width="500"/>
                                </Zoom>
                                </div>
                ...
                <div className="interior-design">
                    ...
                    <div className="row">
                        <div className="col-md-4 offset-md-1 col-12 order-2 order-md-1">
